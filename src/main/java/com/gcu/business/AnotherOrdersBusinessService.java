...
public class AnotherOrdersBusinessService implements OrdersBusinessServiceInterface {
	...
	@Override
	public void init() {
		System.out.println("In the second Service class init method");
	} // end init

	@Override
	public void destroy() {
		System.out.println("In the second Service class destroy method");
	} // end destroy

} // end AnotherOrdersBusinessService
